...
public class MainActivity extends AppCompatActivity {
    ...
    LinearLayout resultsLayout;             // point to layout for `resultsText` so we can dynamically expand
